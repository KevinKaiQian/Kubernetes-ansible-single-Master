 ...
 * 单台master的话`group_vars/all.yml`里的`single_etcd_version`为`v3.1.9`,不建议修改,不然报错,参照下面issue
 ...
 * 勇者可以使用BaseCluster.yml,包含了以上1-5,建议提前把etcd的镜像拉取了,因为是quay.io的镜像拉取速度可能就几十kb,网络组件用calico的话同理
